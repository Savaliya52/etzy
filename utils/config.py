"""
Configuration management for the Etsy Trend Detection Agent.
"""
...
class Config:
    """Configuration manager for the trend detection system."""
        ...
        return {
            ...
            'reporting': {
                ...
                'email': {
                    ...
                    'from_email': '',
                    'to_email': '',
                    'subject_prefix': 'Etsy Trend Report'
                }
            },
            'database': {
                'type': 'sqlite',
    ...
    def _load_env_vars(self):
        ...
        env_mappings = {
            ...
            'EMAIL_HOST': ('reporting.email.smtp_host', str),
            'EMAIL_PORT': ('reporting.email.smtp_port', int),
            'EMAIL_USER': ('reporting.email.from_email', str),
            'EMAIL_PASSWORD': ('reporting.email.password', str)
        }
